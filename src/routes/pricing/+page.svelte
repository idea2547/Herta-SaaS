...
<div class="min-h-[70vh] pb-8 pt-[5vh] px-4">
	...
	<div class="w-full my-8">
		...
		<div class="flex place-content-center">
			<div class="join join-vertical max-w-xl py-6 mx-auto">
				<div class="collapse collapse-arrow join-item border border-primary">
					...
					<div class="collapse-title text-lg font-medium">Is this template free to use?</div>
				...
				<div class="collapse collapse-arrow join-item border border-primary">
					...
					<div class="collapse-content">
						<p>
							The pricing page is part of the boilerplate. It shows how the pricing page integrates
							into the billing portal and the Stripe Checkout flows.
						</p>
					</div>
				</div>
				<div class="collapse collapse-arrow join-item border border-primary">
					<input type="radio" name="faq-accordion" />
					<div class="collapse-title text-lg font-medium">What license is the template under?</div>
					<div class="collapse-content">
		...
		<h2 class="text-xl text-center text-slate-500 mt-1 pb-3">Example feature table</h2>
